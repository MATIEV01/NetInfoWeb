<%@ Page Title="Catálogo de Escuelas" Language="C#" MasterPageFile="~/Themes/NIWeb/NI5.Master" AutoEventWireup="true" CodeBehind="CatalogoEscuelas.aspx.cs" Inherits="NI5sWeb.Modules.Marketing.Escuelas.CatalogoEscuelas" %>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-sm-6 form-field" >
                                        ...
                                        <input type="text" id="escCSM" class="form-control" placeholder="Clave SEP" />
                                    </div>
                                    <div class="col-sm-6 form-field" aria-disabled="true">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 form-field" aria-disabled="true">
                                <label for="escCSJ">Jardín de Niños</label>
                                <br />
                                <input type="text" id="edtCSJ" class="form-control" placeholder="Clave SEP" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6 form-field">
