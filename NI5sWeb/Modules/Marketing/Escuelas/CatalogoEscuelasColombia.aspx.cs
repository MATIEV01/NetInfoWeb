    ...
    public partial class CatalogoEscuelas : System.Web.UI.Page
    {
        ...
        protected void bindSchools(bool post)
        {
            ...
            foreach (DataRow school in schools.Rows)
            {
                ...
                int caux = 0;
                string s = school["Preescolar"].ToString();
                if (school["Preescolar"].ToString() != "") { if (caux > 0) list += ","; list += "Preescolar"; caux++; }
                ...
                list += "<p class=\"list-group-item-text\">Responsable: " + school["NNOM"] + "</p>";
        ...
        protected void setEditSchoolLevels()
        {
            ...
            if (this.dbSetEditSchoolLevels(id, pre, pri, sec))
                Response.Write(1);
            else
                Response.Write(0);
            Response.End();
        ...
        protected bool dbSetEditSchoolLevels(int id,string pre,string pri,string sec)
        {
            return core.executeProcedure("NIW_MK_UpdateEducationLevels " + id + ",'" + pre + "','"  + pri + "','" + sec + "'");
        }
        #endregion
    }
}